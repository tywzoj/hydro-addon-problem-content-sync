...
export const enum CE_StringKey {
    ...
    AlertEditReferredProblem = "You are not allowed to edit a referred problem.",
    ...
    ChangeProblemId = "Change problem ID",
}
...
const strings: Record<string, Record<CE_StringKey, string>> = {
    zh: {
        ...
        [CE_StringKey.AlertEditReferredProblem]: "您不被允许编辑被引用的题目。",
        ...
        [CE_StringKey.ChangeProblemId]: "更改题目 ID",
    },
    zh_TW: {
        ...
        [CE_StringKey.AlertEditReferredProblem]: "您不被允許編輯被引用的題目。",
        ...
        [CE_StringKey.ChangeProblemId]: "更改題目 ID",
    },
};
